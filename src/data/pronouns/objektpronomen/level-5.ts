    ...
    exercises: [
        {
            ...
            questions: shuffleArray([
                ...
                { sentence: "Il a beaucoup de livres ?", prompt: 'Was wird im folgenden Antwortsatz durch "en" ersetzt?', answerContext: 'Antwort: "Oui, il en a beaucoup"', answer: ["de", "livres"], translation_de: "Hat er viele Bücher?" },
